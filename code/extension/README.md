...
## Testing the governance platform (Plans A + B + C)

The full setup (backend + admin console + extension) and the A/B/C test cases now live in the
**[repo README](../../README.md)** → *Quick start — AI governance platform*. Two-laptop stage
version: [`DEMO.md`](DEMO.md). Ethics classifier limits: [`../classifier/README.md`](../classifier/README.md).
